  ...
  return (
    <section className="mb-12 p-4 md:p-8">
      <MaxWidthWrapper className="relative rounded border bg-accordion-content p-6 md:rounded-[24px] md:p-12 lg:rounded-[40px] lg:p-16 xl:px-24 xl:pt-20">
        ...
        <img className="absolute -right-24 -top-20 rotate-180 scale-[0.5] xl:inset-auto xl:-bottom-20 xl:left-0 xl:rotate-0 xl:scale-100" src={"/assets/icons/accordion-illustration.svg"} alt="an arrow facing north-east" />
      </MaxWidthWrapper>
    </section>
  );
};
